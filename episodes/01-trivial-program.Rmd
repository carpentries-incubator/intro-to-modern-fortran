...
## alternative would be to define the program in an R string, eg:
## program <- "
## program hello_world
...
## up two directories because the R code is run from site/built
program <- paste(readLines("../../exercises/01-trivial-program/hello_world.f90"), collapse="\n")
cat("```fortran\n")
cat("\n")
cat(program)
cat("\n")
cat("```\n")
cat(paste0("[Link to run the program](https://dev.lfortran.org/?code=", utils::URLencode(program), ")"))
```
